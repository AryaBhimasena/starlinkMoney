// app/transaksi/top-up/TopUpPulsaModal.jsx
"use client";
...
export default function TopUpPulsaModal({ show, onClose }) {
      ...
      <div className="mobile-modal-content">
        <div className="mobile-mini-bank-container">
          <div className="mobile-mini-bank-header d-flex justify-content-between align-items-center">
            <h5 className="mobile-mini-bank-title m-0">Top Up Pulsa</h5>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mobile-mini-bank-card">
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  <label className="mobile-form-label">Operator</label>
                  <select
                    name="operator"
                    value={form.operator}
                    onChange={handleChange}
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  <label className="mobile-form-label">Nominal Pulsa</label>
                  <input
                    type="text"
                    name="nominal"
